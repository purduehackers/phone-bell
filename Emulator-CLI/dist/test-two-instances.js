...
async function runTest() {
    ...
    let outsideConnection;
    try {
        outsideConnection = await outsideEndpoint.connect(insideNodeId, PHONEBELL_ALPN);
    ...
    if (insideConnection !== null) {
        ...
        await insideConnection.sendDatagram(Buffer.from("Hello Outside!"));
    }
    // Outside listens
    (async () => {
        try {
